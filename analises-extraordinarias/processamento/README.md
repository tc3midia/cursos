# Processamento de Análises Extraordinárias

Base de consulta das 16 transcrições disponíveis neste repositório. A seleção existente não comprova que todas as aulas do curso comercial estejam presentes. Fonte fixada no commit `2130e27fa65c9930a8ef1710bb75ad8fe06233c5`; hashes e caminhos no [manifesto](../conhecimento/manifest.json).
...
- Julgamento separado da amostra definida antes da extração: M02_A02 (planejamento), M03_A05 (operação), M04_A01 (entrada), usando unidades e evidências do inspetor. [Laudos da amostra](revisao/julgamento/).
