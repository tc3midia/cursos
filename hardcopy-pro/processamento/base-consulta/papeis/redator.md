...
No corpo, título e condições use a grafia adotada da tabela do FORMATO; na `evidencia`, copie como a fonte escreve, mesmo errado. Não acrescente passo de tela que a fala não nomeia. Número de dentro de copy de exemplo não vira régua nem regra.
