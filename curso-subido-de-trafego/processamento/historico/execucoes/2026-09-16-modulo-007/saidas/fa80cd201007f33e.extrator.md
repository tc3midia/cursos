...
confianca: media
versao: 1
proposta_tag: "tema: posiciomentos-e-formatos — a taxonomia não possui tema específico para extensões de anúncio"
nota: "O slug de tema proposto reproduz a intenção de posicionamentos e formatos, mas não existe na taxonomia fechada."
```
