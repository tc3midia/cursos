...
Repositório central de fontes transcritas, materiais de apoio e conhecimento derivado dos cursos selecionados por Will. Os vídeos ficam no acervo local e, quando publicados, no Drive; este repositório reúne texto, legendas, metadados, PDFs de apoio e ferramentas de processamento.
...
- [MAC 3.0](mac-3/README.md): 15 aulas com transcrição automática revisada em texto; vídeos na pasta privada do Drive.
- [Análises Extraordinárias](analises-extraordinarias/README.md): 16 aulas da Águia Spread com transcrição automática revisada em texto; vídeos na pasta privada do Drive.
