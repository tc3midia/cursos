...
versao: 2
```
O processo de conversão é o caminho percorrido após o clique no anúncio. Problemas de compra podem estar no checkout, headline, oferta ou público, e não no aquecimento do pixel.
...
nota: "Classificação por gpt-5.6-sol: tarefa genérica inexistente substituída pelas tarefas específicas atuais."
```
Quando um conjunto estiver em aprendizado limitado, busque sair dessa fase, mas não trate esse estado como fim do mundo nem tente evitá-lo a qualquer custo.
