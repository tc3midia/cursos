...
confianca: alta
versao: 2
nota: " Normalização mecânica do marcador temporal; a opção original da interface é Hoje. A seleção continua relativa ao dia da análise, sem atualização das fontes."
```
Pré-condição: estar na visão de campanhas.
1. Abra o filtro de datas e escolha vida inteira, dia em curso, ontem, últimos 7 dias ou últimos 14 dias.
